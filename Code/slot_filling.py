...
DATA_DUMP_PATH = sys.argv[5]


num_filters_context = int(sys.argv[6])
num_filters_entities = int(sys.argv[7])
hidden_layer_dim_value_entities = int(sys.argv[8])
hidden_layer_dim_slot_candidates =  int(sys.argv[9])
